...
for (let _k = 1; _k < 3; _k++) {
   //                   x,   (     y     )
   let _bug = new Enemy(-100, 60 + 85 * _k);
...
let Engine = function () {
   let global = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this;
   ...
   function render() {
       ...
       */
      let rowImages = ['images/water-block.png', // Top row is water
